package com.ync.QuizApplication;
...
//        deleteQuiz();
    ...
    private void setup(){
        //엔티티 생성
        Quiz quiz1 = new Quiz(null, "자바는 객체지향 언어입니다.", true, "쵹쵹이");

        Quiz quiz2 = new Quiz(null, "스프링 데이터는 데이터 엑세스에 관련된 기능을 제공합니다.", true, "빡게영이");

        Quiz quiz3 = new Quiz(null, "프로그램이 많이 등록되어 있는 서버를 라이브러리라고 합니다.", false, "서장워이");

        Quiz quiz4 = new Quiz(null, "@Component는 인스턴스 생성 어노테이션입니다.", true, "이거녀비");

        Quiz quiz5 = new Quiz(null, "스프링 MVC 에서 구현하고 있는 디자인 패턴에서 "+
        ...
        //첫 인수에 저장된 객체를 , 두 번째 인수부터는 저장할 엔티티를 넘겨줌.
...
//        System.out.println("등록한 퀴즈는 " + quiz1 + "입니다.");
    ...
    private void showOne() {
        ...
        // repository 를 사용해서 1건의 데이터를 취득해서 결과를 반환(반환값은 Optional)
    ...
    private void doQuiz() {
        ...
        //repository 를 이용해서 1건의 데이터를 받기(반환값은 Optional)
        ...
        System.out.println("--- 퀴즈 1건을 취득 완료 ---");
